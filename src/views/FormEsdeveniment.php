...
<body>
    ...
    <div class="menuform">
        ...
        <form class="form" name="formEsdeveniment" action="index.php" method="post" enctype="multipart/form-data" onsubmit="return validateEsd()">
            ...
            <input type="hidden" name="r" value="CreateEsdeveniment" required>
            <!-- Input for the event name -->
            <label for="nomEsd">Nom Esdeveniment:</label><br>
            <input class="input" type="text" id="nomEsd" name="nomEsdeveniment"  placeholder="Nom Esdeveniment" required><br>
            <!-- Inputs for the event location (latitude and longitude) -->
            <label for="ubicacioEsd">Ubicació Esdeveniment:</label><br>
            <input class="input" type="number" id="ubicacioEsdY" name="Latitud"  placeholder="Latitud" aria-label="Latitud" required><br>
            <input class="input" type="number" id="ubicacioEsdX" name="Longitud"  placeholder="Longitud" aria-label="Longitud" required><br>
